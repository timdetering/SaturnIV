...
namespace SaturnIV
{
    public class Line3D
    {
        ...
        public void SetPointPosition(Vector3 start, Vector3 end, Color color)
        {
            vertexDeclaration = new VertexDeclaration(
                graphicsDevice,
                VertexPositionColor.VertexElements
        ...
        public void Draw(Vector3 start, Vector3 end, Color color,Matrix mxViewMatrix,Matrix mxProjectionMatrix)
        {
