...
namespace SaturnIV
{
    public class CameraNew
    {
        ...
        public static float zoomFactor = 25.0f;
        float preZoomFactor;
        ...
        public void ResetCamera()
        {
            ...
            projectionMatrix = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(60.0f), 4 / 3, 1f, 500000f);
        }
